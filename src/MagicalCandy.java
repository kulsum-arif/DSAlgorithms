...
public class MagicalCandy {
  ...
  public static void main(String[] args) {
    new MagicalCandy().run();
  }

  // Heap data structure can help -  A heap is a tree-based data structure where root is largest or
  // sma
  // smallest (min heap ) than all children
  int maxCandies(int[] arr, int k) {

    PriorityQueue<Integer> q = new PriorityQueue<>(new QComparator()); // Comparator.reverseOrder()
  ...
  int maxCandies_old(int[] arr, int k) {
